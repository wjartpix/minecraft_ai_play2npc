...
import adris.altoclef.tasks.resources.CollectAmethystBlockTask;
...
import adris.altoclef.tasks.resources.CollectCoarseDirtTask;
import adris.altoclef.tasks.resources.CollectCocoaBeansTask;
import adris.altoclef.tasks.resources.CollectCropTask;
import adris.altoclef.tasks.resources.CollectDripstoneBlockTask;
...
import adris.altoclef.tasks.resources.CollectRedSandstoneTask;
import adris.altoclef.tasks.resources.CollectSandstoneTask;
import adris.altoclef.tasks.resources.CollectSaplingsTask;
import adris.altoclef.tasks.resources.CollectSticksTask;
import adris.altoclef.tasks.resources.CollectStrippedLogTask;
...
import adris.altoclef.tasks.resources.GetSmithingTemplateTask;
...
import adris.altoclef.tasks.resources.wood.CollectHangingSignTask;
...
public class TaskCatalogue {
   ...
   public static ResourceTask getItemTask(ItemTarget target) {
      if (target.isCatalogueItem()) {
         ...
         return (ResourceTask)(target.getMatches().length == 1 ? getItemTask(target.getMatches()[0], target.getTargetCount()) : getSquashedItemTask(target));
      }
   }
   ...
   private static TaskCatalogue.CataloguedResource simple(String name, Item[] matches, Function<Integer, ResourceTask> getTask) {
   ...
   private static TaskCatalogue.CataloguedResource mine(String name, MiningRequirement requirement, Item[] toMine, Item... targets) {
   ...
   private static TaskCatalogue.CataloguedResource mine(String name, MiningRequirement requirement, Block[] toMine, Item... targets) {
      return put(name, targets, count -> new MineAndCollectTask(new ItemTarget(targets, count), toMine, requirement)).dontMineIfPresent();
   }

   private static TaskCatalogue.CataloguedResource mine(String name, MiningRequirement requirement, Block toMine, Item target) {
      return mine(name, requirement, new Block[]{toMine}, target);
   }

   private static TaskCatalogue.CataloguedResource mine(String name, Block toMine, Item target) {
      return mine(name, MiningRequirement.HAND, toMine, target);
   }

   private static TaskCatalogue.CataloguedResource mine(String name, Item target) {
      return mine(name, Block.byItem(target), target);
   }

   private static TaskCatalogue.CataloguedResource shear(String name, Block[] toShear, Item... targets) {
   ...
   private static TaskCatalogue.CataloguedResource shapedRecipe2x2(String name, Item match, int outputCount, String s0, String s1, String s2, String s3) {
   ...
   private static TaskCatalogue.CataloguedResource shapedRecipe3x3(
      String name, Item match, int outputCount, String s0, String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8
   ) {
   ...
   private static TaskCatalogue.CataloguedResource shapedRecipe2x2Block(String name, Item match, String material) {
      return shapedRecipe2x2(name, match, 1, material, material, material, material);
   }

   private static TaskCatalogue.CataloguedResource shapedRecipe2x2Block(String name, Item match, int outputCount, String material) {
      return shapedRecipe2x2(name, match, outputCount, material, material, material, material);
   }

   private static TaskCatalogue.CataloguedResource shapedRecipe3x3Block(String name, Item match, String material) {
      return shapedRecipe3x3(name, match, 1, material, material, material, material, material, material, material, material, material);
   }

   private static TaskCatalogue.CataloguedResource shapedRecipeSlab(String name, Item match, String material) {
      return shapedRecipe3x3(name, match, 6, null, null, null, null, null, null, material, material, material);
   }

   private static TaskCatalogue.CataloguedResource shapedRecipeStairs(String name, Item match, String material) {
      return shapedRecipe3x3(name, match, 4, material, null, null, material, material, null, material, material, material);
   }

   private static TaskCatalogue.CataloguedResource shapedRecipeWall(String name, Item match, String material) {
      return shapedRecipe3x3(name, match, 6, material, material, material, material, material, material, null, null, null);
   }

   private static TaskCatalogue.CataloguedResource smelt(String name, Item[] matches, String materials, Item... optionalMaterials) {
      return put(
         name, matches, count -> new SmeltInFurnaceTask(new SmeltTarget(new ItemTarget(matches, count), new ItemTarget(materials, count), optionalMaterials))
      );
   }

   private static TaskCatalogue.CataloguedResource smelt(String name, Item match, String materials, Item... optionalMaterials) {
      return smelt(name, new Item[]{match}, materials, optionalMaterials);
   }

   private static TaskCatalogue.CataloguedResource smith(String name, Item[] matches, String materials, String tool) {
      return put(
         name, matches, count -> new UpgradeInSmithingTableTask(new ItemTarget(tool, count), new ItemTarget(materials, count), new ItemTarget(matches, count))
      );
   }

   private static TaskCatalogue.CataloguedResource smith(String name, Item match, String materials, String tool) {
      return smith(name, new Item[]{match}, materials, tool);
   }

   private static TaskCatalogue.CataloguedResource mob(String name, Item[] matches, Class mobClass) {
      return put(name, matches, count -> new KillAndLootTask(mobClass, new ItemTarget(matches, count)));
   }

   private static TaskCatalogue.CataloguedResource mob(String name, Item match, Class mobClass) {
   ...
   private static TaskCatalogue.CataloguedResource crop(String name, Item[] matches, Block[] cropBlocks, Item[] cropSeeds) {
      return put(name, matches, count -> new CollectCropTask(new ItemTarget(matches, count), cropBlocks, cropSeeds));
   }

   public static TaskCatalogue.CataloguedResource crop(String name, Item match, Block cropBlock, Item cropSeed) {
      return crop(name, new Item[]{match}, new Block[]{cropBlock}, new Item[]{cropSeed});
   }

   private static void colorfulTasks(
      String baseName, Function<ItemHelper.ColorfulItems, Item> getMatch, BiFunction<ItemHelper.ColorfulItems, Integer, ResourceTask> getTask
   ) {
   ...
   private static TaskCatalogue.CataloguedResource[] woodTasks(
      Function<ItemHelper.WoodItems, String> getCatalogueName,
      Function<ItemHelper.WoodItems, Item> getMatch,
      BiFunction<ItemHelper.WoodItems, Integer, ResourceTask> getTask,
      boolean requireNetherForNetherStuff
   ) {
      List<TaskCatalogue.CataloguedResource> result = new ArrayList<>();
      ...
      for (WoodType woodType : WoodType.values()) {
         ...
         if (match != null) {
            ...
            TaskCatalogue.CataloguedResource t = put(cataloguedName, new Item[]{match}, count -> getTask.apply(woodItems, count));
      ...
      return result.toArray(TaskCatalogue.CataloguedResource[]::new);
   }
   ...
   private static TaskCatalogue.CataloguedResource[] woodTasks(
      String baseName, Function<ItemHelper.WoodItems, Item> getMatch, BiFunction<ItemHelper.WoodItems, Integer, ResourceTask> getTask
   ) {
   ...
   private static void tools(String toolMaterialName, String material, Item pickaxeItem, Item shovelItem, Item swordItem, Item axeItem, Item hoeItem) {
      String s = "stick";
      String o = null;
      shapedRecipe3x3(toolMaterialName + "_pickaxe", pickaxeItem, 1, material, material, material, o, s, o, o, s, o);
      shapedRecipe3x3(toolMaterialName + "_shovel", shovelItem, 1, o, material, o, o, s, o, o, s, o);
      shapedRecipe3x3(toolMaterialName + "_sword", swordItem, 1, o, material, o, o, material, o, o, s, o);
      shapedRecipe3x3(toolMaterialName + "_axe", axeItem, 1, material, material, o, material, s, o, o, s, o);
      shapedRecipe3x3(toolMaterialName + "_hoe", hoeItem, 1, material, material, o, o, s, o, o, s, o);
   }
   ...
   private static void armor(String armorMaterialName, String material, Item helmetItem, Item chestplateItem, Item leggingsItem, Item bootsItem) {
      String o = null;
      shapedRecipe3x3(armorMaterialName + "_helmet", helmetItem, 1, material, material, material, material, o, material, o, o, o);
   ...
   static {
      ...
      mine(
         ...
         new Block[]{Blocks.BROWN_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM, Blocks.RED_MUSHROOM_BLOCK},
      ...
      simple("blaze_rod", Items.BLAZE_ROD, CollectBlazeRodsTask::new).forceDimension(Dimension.NETHER);
      ...
      for (TaskCatalogue.CataloguedResource resource : woodTasks(
         "leaves",
      ...
      for (TaskCatalogue.CataloguedResource woodCatalogue : woodTasks("planks", wood -> wood.planks, (wood, count) -> {
      ...
      for (TaskCatalogue.CataloguedResource woodCatalogue : woodTasks(
         "stripped_logs", wood -> wood.strippedLog, (wood, count) -> new CollectStrippedLogTask(wood.strippedLog, count)
      )) {
         woodCatalogue.dontMineIfPresent();
      }
      ...
      simple("gold_ingot", Items.GOLD_INGOT, CollectGoldIngotTask::new).anyDimension();
      ...
      shapedRecipe3x3("glistering_melon_slice", Items.GLISTERING_MELON_SLICE, 1, str8, str8, str8, str8, "melon_slice", str8, str8, str8, str8);
      ...
      shapedRecipe3x3("nether_brick_fence", Items.NETHER_BRICK_FENCE, 6, o, o, o, B, str13, B, B, str13, B);
      ...
      String str6 = "leather";
      shapedRecipe3x3("leather_horse_armor", Items.LEATHER_HORSE_ARMOR, 1, str6, o, str6, str6, str6, str6, str6, o, str6);
      ...
      woodTasks(
         "pressure_plate",
         woodItems -> woodItems.pressurePlate,
      ...
      woodTasks(
         "button",
         woodItems -> woodItems.button,
         (woodItems, count) -> new CraftInInventoryTask(
            new RecipeTarget(
               woodItems.button,
               1,
               CraftingRecipe.newShapedRecipe(woodItems.prefix + "_button", new ItemTarget[]{new ItemTarget(woodItems.planks, 1), null, null, null}, 1)
            )
         )
      );
      ...
      shapedRecipe3x3("furnace", Items.FURNACE, 1, str5, str5, str5, str5, o, str5, str5, str5, str5).dontMineIfPresent();
      shapedRecipe3x3("dropper", Items.DROPPER, 1, str5, str5, str5, str5, o, str5, str5, "redstone", str5);
      shapedRecipe3x3("dispenser", Items.DISPENSER, 1, str5, str5, str5, str5, "bow", str5, str5, "redstone", str5);
      shapedRecipe3x3("brewing_stand", Items.BREWING_STAND, 1, o, o, o, o, "blaze_rod", o, str5, str5, str5);
      shapedRecipe3x3("piston", Items.PISTON, 1, p, p, p, str5, "iron_ingot", str5, str5, "redstone", str5);
      shapedRecipe3x3("observer", Items.OBSERVER, 1, str5, str5, str5, "redstone", "redstone", "quartz", str5, str5, str5);
      shapedRecipe2x2("lever", Items.LEVER, 1, s, o, str5, o);
      simple("hanging_sign", ItemHelper.WOOD_HANGING_SIGN, CollectHangingSignTask::new).dontMineIfPresent();
      woodTasks(
         "hanging_sign",
         woodItems -> woodItems.hangingSign,
         (woodItems, count) -> new CollectHangingSignTask(woodItems.hangingSign, woodItems.prefix + "_stripped_logs", count)
      );
      ...
      shapedRecipe3x3("anvil", Items.ANVIL, 1, str11, str11, str11, o, str4, o, str4, str4, str4);
      shapedRecipe3x3("cauldron", Items.CAULDRON, 1, str4, o, str4, str4, o, str4, str4, str4, str4);
      shapedRecipe3x3("minecart", Items.MINECART, 1, o, o, o, str4, o, str4, str4, str4, str4);
      shapedRecipe3x3("iron_door", Items.IRON_DOOR, 3, str4, str4, o, str4, str4, o, str4, str4, o);
      shapedRecipe3x3("iron_bars", Items.IRON_BARS, 16, str4, str4, str4, str4, str4, str4, o, o, o);
      shapedRecipe3x3("blast_furnace", Items.BLAST_FURNACE, 1, str4, str4, str4, str4, "furnace", str4, m, m, m);
      shapedRecipe2x2Block("iron_trapdoor", Items.IRON_TRAPDOOR, str4);
      shapedRecipe3x3("armor_stand", Items.ARMOR_STAND, 1, s, s, s, o, s, o, s, "smooth_stone_slab", s);
      String str3 = "obsidian";
      shapedRecipe3x3("enchanting_table", Items.ENCHANTING_TABLE, 1, o, "book", o, "diamond", str3, "diamond", str3, str3, str3);
      shapedRecipe3x3("ender_chest", Items.ENDER_CHEST, 1, str3, str3, str3, str3, "ender_eye", str3, str3, str3, str3).dontMineIfPresent();
      str3 = "brick";
      shapedRecipe3x3("decorated_pot", Items.DECORATED_POT, 1, o, str3, o, str3, o, str3, o, str3, o);
      shapedRecipe3x3("flower_pot", Items.FLOWER_POT, 1, str3, o, str3, o, str3, o, o, o, o);
      shapedRecipe2x2Block("bricks", Items.BRICKS, str3);
      shapedRecipeSlab("brick_slab", Items.BRICK_SLAB, str3);
      shapedRecipeStairs("brick_stairs", Items.BRICK_STAIRS, str3);
      ...
      String str2 = "glass";
      shapedRecipe3x3("glass_pane", Items.GLASS_PANE, 16, str2, str2, str2, str2, str2, str2, o, o, o).dontMineIfPresent();
      simple(
         "carved_pumpkin",
         Items.CARVED_PUMPKIN,
         count -> new CarveThenCollectTask(Items.CARVED_PUMPKIN, count, Blocks.CARVED_PUMPKIN, Items.PUMPKIN, Blocks.PUMPKIN, Items.SHEARS)
      );
      ...
      shapedRecipe3x3(
         "daylight_detector", Items.DAYLIGHT_DETECTOR, 1, "glass", "glass", "glass", "quartz", "quartz", "quartz", "wooden_slab", "wooden_slab", "wooden_slab"
      );
      ...
      shapedRecipe3x3("powered_rail", Items.POWERED_RAIL, 6, str10, o, str10, str10, s, str10, str10, "redstone", str10);
      ...
      shapedRecipe3x3("golden_apple", Items.GOLDEN_APPLE, 1, str9, str9, str9, str9, "apple", str9, str9, str9, str9);
   ...
   private static class CataloguedResource {
      ...
      public TaskCatalogue.CataloguedResource mineIfPresent() {
         this.mineIfPresent = true;
         return this;
      }

      public TaskCatalogue.CataloguedResource dontMineIfPresent() {
         this.mineIfPresent = false;
         return this;
      }

      public TaskCatalogue.CataloguedResource forceDimension(Dimension dimension) {
         this.forceDimension = true;
         this.targetDimension = dimension;
         return this;
      }

      public TaskCatalogue.CataloguedResource anyDimension() {
