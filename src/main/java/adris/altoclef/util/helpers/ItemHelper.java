...
public class ItemHelper {
   ...
   public static final Block[] SAPLING_SOURCES = new Block[]{
      Blocks.OAK_LEAVES,
   ...
   public static final Item[] WOOD = new Item[]{
      Items.ACACIA_WOOD,
      Items.BIRCH_WOOD,
   ...
   public static final Item[] WOOD_BOAT = new Item[]{
      Items.ACACIA_BOAT, Items.BIRCH_BOAT, Items.DARK_OAK_BOAT, Items.OAK_BOAT, Items.JUNGLE_BOAT, Items.SPRUCE_BOAT, Items.MANGROVE_BOAT, Items.CHERRY_BOAT
   };
   ...
   public static final Item[] STRIPPABLE_LOGS = new Item[]{
      Items.ACACIA_LOG,
      Items.BIRCH_LOG,
      Items.DARK_OAK_LOG,
      Items.OAK_LOG,
   ...
   public static final Item[] NETHERITE_ARMORS = new Item[]{
   ...
   private static final Map<Item, Item> logToPlanks = new HashMap<Item, Item>() {
      {
         this.put(Items.CHERRY_LOG, Items.CHERRY_PLANKS);
         this.put(Items.CHERRY_WOOD, Items.CHERRY_PLANKS);
         this.put(Items.STRIPPED_CHERRY_LOG, Items.CHERRY_PLANKS);
         this.put(Items.STRIPPED_CHERRY_WOOD, Items.CHERRY_PLANKS);
         this.put(Items.MANGROVE_LOG, Items.MANGROVE_PLANKS);
         this.put(Items.MANGROVE_WOOD, Items.MANGROVE_PLANKS);
         this.put(Items.STRIPPED_MANGROVE_LOG, Items.MANGROVE_PLANKS);
         this.put(Items.STRIPPED_MANGROVE_WOOD, Items.MANGROVE_PLANKS);
         this.put(Items.ACACIA_LOG, Items.ACACIA_PLANKS);
         this.put(Items.BIRCH_LOG, Items.BIRCH_PLANKS);
         this.put(Items.CRIMSON_STEM, Items.CRIMSON_PLANKS);
         this.put(Items.DARK_OAK_LOG, Items.DARK_OAK_PLANKS);
         this.put(Items.OAK_LOG, Items.OAK_PLANKS);
         this.put(Items.JUNGLE_LOG, Items.JUNGLE_PLANKS);
         this.put(Items.SPRUCE_LOG, Items.SPRUCE_PLANKS);
         this.put(Items.WARPED_STEM, Items.WARPED_PLANKS);
         this.put(Items.STRIPPED_ACACIA_LOG, Items.ACACIA_PLANKS);
         this.put(Items.STRIPPED_BIRCH_LOG, Items.BIRCH_PLANKS);
         this.put(Items.STRIPPED_CRIMSON_STEM, Items.CRIMSON_PLANKS);
         this.put(Items.STRIPPED_DARK_OAK_LOG, Items.DARK_OAK_PLANKS);
         this.put(Items.STRIPPED_OAK_LOG, Items.OAK_PLANKS);
         this.put(Items.STRIPPED_JUNGLE_LOG, Items.JUNGLE_PLANKS);
         this.put(Items.STRIPPED_SPRUCE_LOG, Items.SPRUCE_PLANKS);
         this.put(Items.STRIPPED_WARPED_STEM, Items.WARPED_PLANKS);
         this.put(Items.ACACIA_WOOD, Items.ACACIA_PLANKS);
         this.put(Items.BIRCH_WOOD, Items.BIRCH_PLANKS);
         this.put(Items.CRIMSON_HYPHAE, Items.CRIMSON_PLANKS);
         this.put(Items.DARK_OAK_WOOD, Items.DARK_OAK_PLANKS);
         this.put(Items.OAK_WOOD, Items.OAK_PLANKS);
         this.put(Items.JUNGLE_WOOD, Items.JUNGLE_PLANKS);
         this.put(Items.SPRUCE_WOOD, Items.SPRUCE_PLANKS);
         this.put(Items.WARPED_HYPHAE, Items.WARPED_PLANKS);
         this.put(Items.STRIPPED_ACACIA_WOOD, Items.ACACIA_PLANKS);
         this.put(Items.STRIPPED_BIRCH_WOOD, Items.BIRCH_PLANKS);
         this.put(Items.STRIPPED_CRIMSON_HYPHAE, Items.CRIMSON_PLANKS);
         this.put(Items.STRIPPED_DARK_OAK_WOOD, Items.DARK_OAK_PLANKS);
         this.put(Items.STRIPPED_OAK_WOOD, Items.OAK_PLANKS);
         this.put(Items.STRIPPED_JUNGLE_WOOD, Items.JUNGLE_PLANKS);
         this.put(Items.STRIPPED_SPRUCE_WOOD, Items.SPRUCE_PLANKS);
         this.put(Items.STRIPPED_WARPED_HYPHAE, Items.WARPED_PLANKS);
      }
   };
   private static final Map<Item, Item> planksToLogs = new HashMap<Item, Item>() {
      {
         this.put(Items.CHERRY_PLANKS, Items.CHERRY_LOG);
         this.put(Items.MANGROVE_PLANKS, Items.MANGROVE_LOG);
         this.put(Items.ACACIA_PLANKS, Items.ACACIA_LOG);
         this.put(Items.BIRCH_PLANKS, Items.BIRCH_LOG);
         this.put(Items.CRIMSON_PLANKS, Items.CRIMSON_STEM);
         this.put(Items.DARK_OAK_PLANKS, Items.DARK_OAK_LOG);
         this.put(Items.OAK_PLANKS, Items.OAK_LOG);
         this.put(Items.JUNGLE_PLANKS, Items.JUNGLE_LOG);
         this.put(Items.SPRUCE_PLANKS, Items.SPRUCE_LOG);
         this.put(Items.WARPED_PLANKS, Items.WARPED_STEM);
      }
   };
   private static final Map<Item, Item> strippedToLogs = new HashMap<Item, Item>() {
      {
         this.put(Items.STRIPPED_CHERRY_LOG, Items.CHERRY_LOG);
         this.put(Items.STRIPPED_MANGROVE_LOG, Items.MANGROVE_LOG);
         this.put(Items.STRIPPED_ACACIA_LOG, Items.ACACIA_LOG);
         this.put(Items.STRIPPED_BIRCH_LOG, Items.BIRCH_LOG);
         this.put(Items.STRIPPED_CRIMSON_STEM, Items.CRIMSON_STEM);
         this.put(Items.STRIPPED_DARK_OAK_LOG, Items.DARK_OAK_LOG);
         this.put(Items.STRIPPED_OAK_LOG, Items.OAK_LOG);
         this.put(Items.STRIPPED_JUNGLE_LOG, Items.JUNGLE_LOG);
         this.put(Items.STRIPPED_SPRUCE_LOG, Items.SPRUCE_LOG);
         this.put(Items.STRIPPED_WARPED_STEM, Items.WARPED_STEM);
      }
   };
   private static final Map<MapColor, ItemHelper.ColorfulItems> colorMap = new HashMap<MapColor, ItemHelper.ColorfulItems>() {
      {
         this.p(
            DyeColor.RED,
            "red",
      ...
      void p(
         ...
         Item carpet,
         Item stainedGlass,
         Item stainedGlassPane,
         Item terracotta,
         Item glazedTerracotta,
         Item concrete,
         Item concretePowder,
         Item banner,
         Item shulker,
   ...
   private static final Map<WoodType, ItemHelper.WoodItems> woodMap = new HashMap<WoodType, ItemHelper.WoodItems>() {
      {
         this.p(
            WoodType.CHERRY,
            "cherry",
   ...
   public static final HashMap<Item, Item> cookableFoodMap = new HashMap<Item, Item>() {
      {
         this.put(Items.PORKCHOP, Items.COOKED_PORKCHOP);
         this.put(Items.BEEF, Items.COOKED_BEEF);
         this.put(Items.CHICKEN, Items.COOKED_CHICKEN);
         this.put(Items.MUTTON, Items.COOKED_MUTTON);
         this.put(Items.RABBIT, Items.COOKED_RABBIT);
         this.put(Items.SALMON, Items.COOKED_SALMON);
         this.put(Items.COD, Items.COOKED_COD);
   ...
   public static ItemHelper.ColorfulItems getColorfulItems(MapColor color) {
      return colorMap.get(color);
   }

   public static ItemHelper.ColorfulItems getColorfulItems(DyeColor color) {
      return getColorfulItems(color.getMapColor());
   }

   public static Collection<ItemHelper.ColorfulItems> getColorfulItems() {
      return colorMap.values();
   }

   public static ItemHelper.WoodItems getWoodItems(WoodType type) {
      return woodMap.get(type);
   }

   public static Collection<ItemHelper.WoodItems> getWoodItems() {
   ...
   private static boolean isStackProtected(AltoClefController mod, ItemStack stack) {
      if (stack.isEnchanted() && mod.getModSettings().getDontThrowAwayEnchantedItems()) {
         ...
         return ItemVer.hasCustomName(stack) && mod.getModSettings().getDontThrowAwayCustomNameItems()
            ? true
            : mod.getBehaviour().isProtected(stack.getItem()) || mod.getModSettings().isImportant(stack.getItem());
      }
   }
   ...
   public static boolean canThrowAwayStack(AltoClefController mod, ItemStack stack) {
      if (stack.isEmpty()) {
         ...
         return isStackProtected(mod, stack) ? false : mod.getModSettings().isThrowaway(stack.getItem()) || mod.getModSettings().shouldThrowawayUnusedItems();
      }
   }
